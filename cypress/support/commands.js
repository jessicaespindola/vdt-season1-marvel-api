...
Cypress.Commands.add("setToken", function () {
  cy.api({
    ...
    url: "/sessions",
    body: {
      email: "jessica.espindola@qacademy.io",
      password: "qa-cademy",
    },
...
Cypress.Commands.add("back2ThePast", function () {
  cy.api({
    method: "DELETE",
    url: "/back2thepast/62b646873f46800016dd6f10",
    failOnStatusCode: false,
  }).then(function (response) {
    expect(response.status).to.eql(200);
  });
...
// GET requisição que busca o personagem
...
// GET requisição que busca o personagem por id
...
// DELETE requisição que deleta o personagem por id
